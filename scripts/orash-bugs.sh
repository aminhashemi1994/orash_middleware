...
نمی‌شود، چون تنها راه دیدنش ساختن یک کالای واقعی است:

  کد فرستاده‌شده : 112420000031506404071   (۲۱ رقم)
  کد ثبت‌شده     : 11242000003150640407    (۲۰ رقم — رقم آخر افتاده)

پاسخ سرویس موفقیت‌آمیز بود:
  "کالاي مورد نظر با11242000003150640407 درج شد"

همین کدهای ۲۱ رقمی وقتی از نرم‌افزار دسکتاپ اوراش وارد می‌شوند کامل ثبت
می‌شوند؛ پس محدودیت در مسیر وب‌سرویس است نه در طرح کدگذاری کالا.

سرریز bigint نیست (bigint تا ۱۹ رقم جا می‌دهد و ۱۹ رقم هم برنگشته)؛ به نظر
می‌رسد پارامتر یا ستون این مسیر ۲۰ کاراکتری است.

درخواست: کد کالا در CreateGood باید همان ۲۱ رقم را کامل نگه دارد، یا اگر جا
نمی‌شود، درخواست را با خطا رد کند — نه اینکه بی‌صدا ببرد و Done برگرداند.
NOTE
