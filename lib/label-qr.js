...
// Everything the service requires beyond the three fields Excel sends. Zero
// until the real unit / packing / group codes are known — change them here and
// every later label follows. `type` is the one that cannot be zero: the panel
// accepts only 1 (کالا) or 2 (خدمات), and a printed product label is 1.
const FIXED = {
  type: 1,
  unitIdRef: 0,
  unitPackingCodeRef: 0,
  mainGroupCodeRef: 0,
  secondGroupCodeRef: 0,
};
